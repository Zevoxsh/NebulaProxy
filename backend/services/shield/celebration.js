...
.nb-cel-check{width:56px;height:56px;margin-bottom:10px}
...
@media (prefers-reduced-motion:reduce){#nb-cel.show .nb-cel-check circle,#nb-cel.show .nb-cel-check path{animation:none;stroke-dashoffset:0}}
</style>
<script>
