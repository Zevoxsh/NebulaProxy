...
export default function AdminTunnelDetail() {
  const { id } = useParams();
  const navigate = useNavigate();
  const basePath = '/admin/tunnels';
  ...
  // Reached only via the admin route tree — always allowed to manage.
      ...
      <AdminCard>
        <AdminCardContent className="p-3">
          <div className="flex flex-wrap gap-2">
            <span className="rounded-full border px-4 py-2 text-xs font-medium border-admin-primary/30 bg-admin-primary/10 text-admin-primary">
